document.addEventListener('DOMContentLoaded', () => {
  ...
  const changeNotificationSwitchState = (state) => {
    const notificationParamRow = notifSwitch.closest(".item");
    const notifStatusIcon = $('.notif-status-icon');
  ...
  const push = {
    subscribe : () => {
      ...
      return checkNotificationPermission()
        ...
        .then(subscription => push.sendSubscriptionToServer(subscription, 'POST'))
    ...
    updateSubscription : () => {
      navigator.serviceWorker.ready
        ...
        .then(subscription => {
          ...
          return push.sendSubscriptionToServer(subscription, 'PUT');
        })
    ...
    unsubscribe : () => {
      ...
      navigator.serviceWorker.ready
        ...
        .then(subscription => {
          ...
          return push.sendSubscriptionToServer(subscription, 'DELETE');
        })
    ...
    sendSubscriptionToServer : (subscription, method) => {
      ...
      return fetch('src/call_api.php?endpoint=push-subscription', {
        method,
