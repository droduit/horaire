! function(e, t) {
    ...
    var We = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        Ce = "Janvier_Février_Mars_Avril_Mai_Juin_Juillet_Aout_Septembre_Octobre_Novembre_Decembre".split("_");
    var He = "Jan_Fev_Mar_Avr_Mai_Jun_Jul_Aou_Sep_Oct_Nov_Dec".split("_");
    ...
    var Ze = "Dimanche_Lundi_Mardi_Mercredi_Jeudi_Vendredi_Samedi".split("_");
    var ze = "Dim_Lun_Mar_Mer_Jeu_Ven_Sam".split("_");
    var $e = "Di_Lu_Ma_Me_Je_Ve_Sa".split("_");
    var qe = ae;
    var Je = ae;
    var Be = ae;
