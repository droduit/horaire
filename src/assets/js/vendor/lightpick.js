...
(function (root, factory) {
    ...
    renderCalendar = function(el, opts)
    {
        ...
        opts.onRenderCalendar.call(this);
    },
        ...
        self._onMouseEnter = function(e)
        {
            ...
            if ((opts.startDate && !opts.endDate) || opts.repick) {
                ...
                if (opts.hoveringTooltip) {
                    ...
                    var disabledDays = self.el.querySelectorAll('.is-in-range.is-user-disabled, .is-in-range.is-weekend');
                   
                    var daysToTakeOnVacations = days;
                    if(disabledDays != null) {
                        daysToTakeOnVacations -= disabledDays.length;
                    }
                    ...
                    if (days > 0 && !target.classList.contains('is-disabled')) {
                        ...
                        var htmlTooltip = 'A déduire de votre solde vacances : <b>'+daysToTakeOnVacations + ' ' + pluralText+'</b>.<br>';
                        htmlTooltip += 'Profitez réellement en vacances de : <b>'+days + ' ' + pluralText+'</b>.';

                        self.showTooltip(target, htmlTooltip);
                    }
                    else {
                        self.hideTooltip();
                    }
    ...
    Lightpick.prototype = {
        ...
        resetPosition: function() 
        {
            this.el.style.top = '';
            this.el.style.left = '';
            this._opts.onRenderCalendar.call(this);
        },
